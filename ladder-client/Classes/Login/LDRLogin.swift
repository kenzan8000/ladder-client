...
//     /*
//     Publishers.Merge(
//       URLSession.shared.publisher(for: LDRRequest.login(username: loginParam.username, password: loginParam.password)),
//       URLSession.shared.publisher(for: LDRRequest.session(username: loginParam.username, password: loginParam.password, authenticityToken: ))
//     )
//     */
//   }
//
