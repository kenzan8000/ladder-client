...
// MARK: - SignInNetworkingMock

final class SignInNetworkingMock: SignInNetworkingProtocol {
    var signInHTMLData = Data()
    var signInResponse = URLResponse()
    var sessionHTMLData = Data()
    var sessionResponse = URLResponse()

    func signIn(username: String, password: String) async throws -> (Data, URLResponse) {
        (signInHTMLData, signInResponse)
    }
    
    func session(username: String, password: String, authenticityToken: String) async throws -> (Data, URLResponse) {
        (sessionHTMLData, sessionResponse)
    }
...
extension String {
    ...
    <link rel="stylesheet" media="screen" href="/assets/application-1cd259220a654815f3c6db7b837fd85e9e9e972580d24ed92427b8731c9ff950.css" />
    </head>
    <body class='sessions'>
    <div id='container'>
    <div class='navi'>
    ...
    <div id='content'>
    <h2>Sign in</h2>
    <form action="/session" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Fnfu3ODtX/l7TozdDm7425yHGHJqQ+7Oc43XShAQExIR5+ZsAvXZOK8jpdc9Gx+HXIxCwfZTSvYH5MkJ1QoZ2Q==" />
    <dl>
    <dt>
    ...
    <div class='submit'><input type="submit" name="commit" value="Sign In" /></div>
    </form>
    ...
    <script>
      var ApiKey = 'bcaeeff1e5d7cbb5f59edfd485eb1436';
    </script>
    <script src="/assets/application-bdce19e790c36e9d1e975f9b320de4befd2e9dfeef576bc459aa501cb1b1f6bc.js"></script>
    </body>
    </html>
    """
    
    static let sessionHTMLString = """
    ...
    <head>
      ...
      <link rel="stylesheet" media="screen" href="/assets/reader-81d5d0b5b723c1f39fe8789c1e2400316a4a353226e36467ffbb0e9a09c6e3de.css" />
    ...
    <table width="100%" style="position:absolute;margin:1px 0 0 0;padding:0" cellpadding="0" cellspacing="0" border="0">
      ...
      <td align="right" nowrap  style="padding-left:12px;padding-top:2px;vertical-align:top;">
        <div id="my_menu" style="line-height:100%;padding:4px 6px 0px 0;text-align:right">
          <span id="welcome">welcome <a href="/user/kenzan8000">kenzan8000</a></span>
          |&nbsp;<a onclick="init_config();return false;" href="#config">Settings</a>
          |&nbsp;<a target="_self" href="/account">Account</a>
                            |&nbsp;<a target="_self" href="/logout">Sign Out</a>
        </div>
      </td></tr>
      </table>
    </div>
    ...
    <div id="subscribe_window">
      ...
      <div class="body">
        <div id="add_feed">
          <form id="discover_form" action="/api/feed/discover" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="nd5pZcr8hfwYCO/URBKFrE14AsesIElnD8HKPH/3vQMs4gAna4mQHgoKT8Y7Ag9UUZueoZVEURW9mei+pJ2HfQ==" />
        ...
        <div id="import_feed" style="display:none">
          <form target="_blank" enctype="multipart/form-data" action="/import" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="kvuL9TgYCCRfwYvuL+b6ZaA9aFGRiU6/tfeFRS+Qmvkjx+K3mW0dxk3DK/xQ9nCdvN70N6jtVs0Hr6fH9Pqghw==" />
            <b>file</b> : <input type="file" name="opml" style="width:230px"> <input type="submit" value=" Upload " style="width:90px">
    </form>      <form target="_blank" enctype="multipart/form-data" action="/import" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="dweWoGrg7veyYu0OwIcNBlJRdQ6zbw9IhEnlATPrTyfGO//iy5X7FaBgTRy/l4f+TrLpaIoLFzo2EceD6IF1WQ==" />
    ...
    </form>      <div style="float:left" class="discover_help">
            <a href="/import">
              <img src="/img/icon/new_window.gif" border="none">
    </a>      </div>
        </div>
    ...
    <script src="/assets/reader-75742cb2657ff14212b590d022f801935987db00a34d4db85687bca977324cd0.js"></script>

    </body>
    </html>
    """
    
    static let sessionHTMLApiKey = "88ea15c16fc915fc27392b7dedc17382"
}

// MARK: - Data Extension

extension Data {
    static let signInHTMLData: Data = String.signInHTMLString.data(using: .utf8)!
    static let sessionHTMLData: Data = String.sessionHTMLString.data(using: .utf8)!
}
